...
public class BookShop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jabulani Store");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtbcode, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String sql = "INSERT INTO buku VALUES('" + txtbcode.getText() + "',"
                    + "'" + txtbname.getText() + "',"
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE buku SET id='" + txtbcode.getText() + "',"
                    + "namabuku='" + txtbname.getText() + "',"
                    + "qty='" + jComboBox1.getSelectedItem() + "',"
                    + "harga='" + txtprice.getText() + "' WHERE id='" + txtbcode.getText() + "'";

            java.sql.Connection conn = (Connection) Konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
            JOptionPane.showMessageDialog(null, "Update Data Berhasil Cuy");
            muncul();
            kosong();
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        String codebuku = jTable2.getValueAt(baris, 1).toString();
        txtbcode.setText(codebuku);
        String namabuku = jTable2.getValueAt(baris, 2).toString();
        txtbname.setText(namabuku);
        String jbbuku = jTable2.getValueAt(baris, 3).toString();
        jComboBox1.setSelectedItem(jbbuku);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "DELETE FROM buku where id='" + txtbcode.getText() + "'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            InputStream is = BookShop.class.getResourceAsStream("/Laporan/gui_pbo.jasper");
